...
export const appConfig = {
  ...
  config: {
    ...
    historyInitialSet: [
      { name: 'BOJONEGORO,ID',   nameUC: 'BOJONEGORO,ID',   lastQueried: + new Date(), },
      { name: 'BAURENO,ID', nameUC: 'BAURENO,ID', lastQueried: + new Date(), },
      { name: 'KEPOHBARU,ID', nameUC: 'KEPOHBARU,ID', lastQueried: + new Date(), },
      { name: 'JOMBANG,ID', nameUC: 'JOMBANG,ID', lastQueried: + new Date(), },
    ],
    api: {
